...
>>>>>>> DevelopmentSolver
                ...
                $scope.usuarios.$remove($scope.usuario).then(function (ref) {
                    // data has been deleted locally and in the database
                    $window.alert("El usuario ha sido eliminado de la base de datos");

                    $scope.auth.$deleteUser().then(function () {
                        console.log("El usuario ha sido removido de la autenticación");
                    }).catch(function (error) {
                        console.error("Error: ", error);
                    });
